...
#SBATCH -e 09_TajimasD/00_error_files/03_TajimasD_SCH_5kb_vcftools.err
#SBATCH -o 09_TajimasD/00_error_files/03_TajimasD_SCH_5kb_vcftools.out
#SBATCH -J SCH_D_vcftools
...
--TajimaD 5000 --out 01_SCH80_1e6_vcftools_win5kb
