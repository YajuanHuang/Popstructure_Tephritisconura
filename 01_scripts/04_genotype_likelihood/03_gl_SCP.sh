...
#SBATCH -e 04_genotype_likelihood/00_error_files/03_SCP.err
#SBATCH -o 04_genotype_likelihood/00_error_files/03_SCP.out
#SBATCH -J SCP
#SBATCH -D /proj/snic2020-6-222/Projects/Tconura/working/Yajuan/003_new_angsd

module load bioinfo-tools ANGSD/0.933

mkdir 04_genotype_likelihood/03_SCP
...
-b 02_info/03_SCP_bam.list \
-out 04_genotype_likelihood/03_SCP/01_SCP \
-minInd 12 -setMinDepth 39 -setMaxDepth 392 -SNP_pval 1e-6
