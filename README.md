...
### Required programs:
- BWA-ME/0.7.17 (<https://github.com/lh3/bwa>)
...
# 03_Mapping_and_dedupliaction
**Note:** This part was did by Chao Yan(Github page:<https://github.com/YanNianqun>), all the scripts were provided by him. Thanks very much for his work!
- 3.1 Mapping
  - The raw reads were mapped to the *Tephritis conura* reference genome using BWA-MEM(0.7.17) with the standard parameters.
  - Using the script: `01_mapping.sh` in directory *01_scripts/03_Mapping_and_dedupliaction/*
- 3.2 Depulication
  - Using MarkDuplicates function of Picard Tools(<http://broadinstitute.github.io/picard>) to deduplicate reads.
  - Using the script: `02_deduplicate.sh` in directory *01_scripts/03_Mapping_and_dedupliaction/*
- 3.3 Checking the deduplicated bam files
  - Using Qualimap bamqc
  - Using the script: `03_bamQC.sh` in the directry *01_scripts/03_Mapping_and_dedupliaction/*


# 04_Genotype_likelihood
